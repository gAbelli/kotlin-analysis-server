...
class KotlinLanguageServer : LanguageServer, LanguageClientAware {
    ...
    override fun initialize(params: InitializeParams?): CompletableFuture<InitializeResult> {
        ...
        client?.logMessage(MessageParams(MessageType.Info, params?.toString()))
        ...
        val sourceRoots = workspaceFolders
            .map {
                Path.of(URI(it.uri))
//                    .resolve("app").resolve("src").resolve("main").resolve("kotlin")
            }
        client?.logMessage(MessageParams(MessageType.Info, workspaceFolders.toString()))
        client?.logMessage(MessageParams(MessageType.Info, sourceRoots.toString()))
        ...
        client?.logMessage(MessageParams(MessageType.Info, session.modulesWithFiles.toString()))
